      ...
      <main>
        <div>
          <div className={styles.add}>
            <h2>PLAYER TEST</h2>
            <form className={styles.addExhibitionForm} >


              <div className={styles.exhibitionDetail}>
                  <label className={styles.exhibitionDetailLabel}>Player</label>
                  <input className={styles.inputfile} type="text" id="customFile" placeholder="Enter URL"
                  onChange={onChange}/>
            ...
            <div>
              <ReactPlayer url='https://www.youtube.com/watch?v=L93hyPiltLA' config={{ playerVars: { showinfo: 1 } }} controls/>
            </div>
          </div>
        </div>
      </main>
